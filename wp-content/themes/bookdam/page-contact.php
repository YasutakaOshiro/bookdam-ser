        ...
        <div class="main__info">
            <div class="main__info--txtbox">
                <h1 class="common_bookttl">
                    <span class="enb entxt">CONTACT</span>
                    <span class="jp">ご相談・お問い合わせ</span>
                </h1>
                <p class="lead">私たちは、出版を通じて御社のビジョン実現をサポートします。<br class="pc">出版に関するご相談やご質問がありましたら、<br class="pc">お気軽にお問い合わせください。</p>
            </div>
            <div class="main__info--case">
                <h2 class="ttl">これまでのご相談事例</h2>
                <ul class="list">
                    <li>初めての出版でも成果を出せるか不安です</li>
                    <li>地方企業でも出版で認知度を上げられる？</li>
                    <li>出版を通じて採用や組織の課題を解決したい</li>
                    <li>出版する際の具体的な準備は何が必要ですか？</li>
                </ul>
            </div>
            <div class="main__info--staff"><img src="<?php echo home_url('asset/img/contact/img_staff01.webp'); ?>" alt=""></div>
        </div>
        <div class="form">
                    ...
                    <dl class="flx aifs">
                        ...
                        <dd>
                            <div class="textarea_box">
                                <textarea name="content" id="" cols="30" rows="10" class="textarea text_border"
                                    placeholder="ご自由にご記入ください。"></textarea>
                                <span class="err errReq errContent"></span>
                            </div>
                        </dd>
                    </dl>
                </div>
